    ...
    <div class>
        ...
        <div class="question" v-for="question in questions" :key="question.id">
            ...
            <div v-for="item in question.choices" :key="item.id">
                <div class="choices" :class="{ answer: item.is_correct, wrong: item.choice==='Virus'}">{{ item.choice }}</div>
            </div>
            </div>
        </div>
        </div>
      ...
      questions: [
          ...
          },
          {
              ...
              choices: [
                ...
                {id: 1, choice: 'The logical address is added', is_correct: false},
                {id: 1, choice: 'The physical address is added', is_correct: true},
                {id: 1, choice: 'The process port number is added.', is_correct: false}
              ]
          },
      ]
        }
